        ...
        <section className="py-16 md:py-32">
            <div className="mx-auto max-w-6xl px-6">
                <div className="mx-auto max-w-2xl space-y-6 text-center">
                    ...
                    <p className="text-muted-foreground">Choose the perfect plan for your design needs. All plans include access to our core component library.</p>
                </div>
                ...
                <div className="mt-8 grid gap-6 [--color-card:var(--color-muted)] *:border-none *:shadow-none md:mt-20 md:grid-cols-3 dark:[--color-muted:var(--color-zinc-900)]">
                    <Card className="flex flex-col">
                        <CardHeader>
                            ...
                            <CardDescription className="text-sm">For individual developers</CardDescription>
                        </CardHeader>
                    ...
                    <Card className="relative">
                        ...
                        <div className="flex flex-col">
                            <CardHeader>
                                ...
                                <CardDescription className="text-sm">For professional developers</CardDescription>
                            </CardHeader>
                    ...
                    <Card className="flex flex-col">
                        <CardHeader>
                            ...
                            <CardDescription className="text-sm">For teams up to 5 members</CardDescription>
                        </CardHeader>
