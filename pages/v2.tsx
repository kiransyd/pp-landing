...
export default function V2() {
  ...
  max-width: 280px;
        ...
        <div className="hero-inner">
          ...
          >
            ...
            <motion.h1 variants={itemVariant} className="hero-headline">
              The night before an exam,<br />you should feel ready.
            </motion.h1>
            <motion.p variants={itemVariant} className="hero-sub">
              PracticePapers.io gives you real HSC-style questions, worked solutions, and a tool that learns where you're going wrong — so you can fix it before it costs you marks.
            </motion.p>
      ...
      <section className="pain-section" id="pain">
        ...
        >
          <motion.div className="pain-content">
            <motion.span variants={itemVariant} className="section-label">sound familiar?</motion.span>
            <motion.h2 variants={itemVariant} className="section-headline">You've done the work.<br />But it doesn't feel like it.</motion.h2>
            <motion.div variants={itemVariant} className="pain-body">
              <p>You've been to every class. You've got the notes. You can follow worked examples line by line. But in the exam, when the integration question is set up slightly differently — or the Extension 1 proof goes in a direction you didn't expect — your mind goes blank.</p>
              <p><strong>That's not a you problem. That's a practice problem.</strong></p>
              <p>Re-reading your maths notes feels productive. It isn't. The only thing that builds exam skill in maths is sitting with a real question, attempting it cold, checking where your reasoning broke down, and doing it again. That's it.</p>
              <p><strong>The students scoring in the top bands for Advanced and Extension aren't smarter. They've just done more past papers — properly.</strong></p>
            </motion.div>
          </motion.div>
      ...
      <section className="solution-section">
        ...
        >
          <motion.div variants={itemVariant}>
            <span className="solution-eyebrow">the shift</span>
            <h2 className="solution-headline">Practice that actually prepares you.</h2>
            <p className="solution-body">
              PracticePapers.io is built around one idea: the best way to prepare for HSC Mathematics is to do HSC-quality questions — across Standard, Advanced, Extension 1, and Extension 2 — check your answers against worked solutions, and track exactly which topics keep tripping you up. Not passive review. Deliberate, targeted maths practice — with the feedback loop that makes it stick.
            </p>
          </motion.div>
      ...
      <section className="social-section">
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
        >
          <motion.h2 variants={itemVariant} className="social-headline">What students are saying</motion.h2>
        ...
        >
          ...
          <motion.div variants={containerVariant} className="pricing-cards">
            ...
            <motion.div variants={itemVariant} whileHover={{ y: -8, boxShadow: "0 25px 50px -12px rgba(0,0,0,0.15)" }} className="pricing-card recommended">
              ...
              <p className="pricing-descriptor">For students who want every advantage.</p>
              <hr className="pricing-divider" />
              <ul className="pricing-features">
                {[
      ...
      <section className="close-section">
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
        >
          <motion.h2 variants={itemVariant} className="close-headline">You already know what you need to do.</motion.h2>
          <motion.p variants={itemVariant} className="close-body">More HSC maths papers. More worked examples on the topics that keep tripping you up — Integration, Proof, Probability, whatever it is for you. You've known that for a while. The question is just whether you have the right tool to do it properly. This is that tool.</motion.p>
          <motion.div variants={itemVariant}>
