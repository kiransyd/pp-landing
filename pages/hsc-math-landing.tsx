          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="text-center sm:mx-auto">
              ...
              <TextEffect
                ...
                Stop Struggling with HSC Mathematics
              </TextEffect>
                ...
                <div
                  ...
                  <Button
                    ...
                    <Link href="#browse-papers">
                      <span className="text-nowrap">Browse All Papers</span>
                    </Link>
                  </Button>
                </div>
                <Button
                ...
                <div className="p-8 md:p-12">
                  <div className="flex flex-col gap-6 md:gap-10">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 md:items-center">
                      ...
                      <div>
                        <h3 className="text-xl font-geist-sans font-bold mb-2">Watching generic YouTube tutorials</h3>
                  ...
                  <div className="mt-6">
                    <div className="flex justify-between">
                      ...
                      <Button variant="default" size="sm" className="rounded-lg">
                        Continue to Next Step <ChevronRight className="ml-1 h-4 w-4" />
                      </Button>
                    </div>
                  </div>
                </div>
